...
function Editprofile()
{
  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      const res = await axios.post('http://13.233.4.104:5000/api/uploadimage', formData, {
        headers: {
...
const getmyprojects=()=>{
  var to="Bearer ";
        ...
        const token=tok.replace(/["']/g, "")
  const body={"authorization":token}
  axios.post("http://13.233.4.104:5000/api/getmyprojects",body)
...
axios.post('http://13.233.4.104:5000/api/updateprofile',body)
